<template>
  <div>
    <div style="border:1px solid blue;width: 200px;height: 200px;margin: 50px auto;">
      <svg width="200px" height="200px" version="1.1" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- Wave -->
          <g id="wave">
              <path id="wave-2" fill="rgba(154, 205, 50, .8)" d="M 0 100 C 133.633 85.12 51.54 116.327 200 100 A 95 95 0 0 1 0 100 Z"> <!--贝塞尔曲线核心-->
